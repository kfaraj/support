 ...
 * </ul>
 *
 * @deprecated Use {@link AppCompatToggleButton} instead.
 */
@Deprecated
public class SupportToggleButton extends AppCompatToggleButton
     ...
     */
    public SupportToggleButton(@NonNull Context context) {
        super(context);
    }
